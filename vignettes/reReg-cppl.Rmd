...
This acheives a `r 100 * round(1 - fit2$par1.se / fit$par1.se, 4)[1]`\% and
...
This acheives a `r 100 * round(1 - fit3$par1.se / fit$par1.se, 4)[1]`\% and
`r 100 * round(1 - fit3$par1.se / fit$par1.se, 4)[2]`\% efficiency gain, respectively.
Althought the above example assumes the covariates are time-independent, 

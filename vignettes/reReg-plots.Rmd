...
The `reSurv` object is then used to create event plots and mean cumulative function (CSM) plots.
...
A side-by-side MCF plot, showing the CSM functions with and without risk adjustment, is shown in Figure 6.
